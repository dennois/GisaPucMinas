            ...
            class i {
                ...
                removeReouteConnectionSelected() {
                    this.dispatch("connectionUnselected", !0),
                        ...
                        this.connection_selected.parentElement.querySelectorAll(".main-path").forEach((e, t) => {
                ...
                click(e) {
                    if ((this.dispatch("click", e), "fixed" === this.editor_mode)) {
                        ...
                        "view" === this.editor_mode
                            ? (null != e.target.closest(".drawflow") || e.target.matches(".parent-drawflow")) && ((this.ele_selected = e.target.closest(".parent-drawflow")), e.preventDefault())
                    ...
                    switch (this.ele_selected.classList[0]) {
                        case "drawflow-node":
                            null != this.node_selected && (this.node_selected.classList.remove("selected"), this.node_selected != this.ele_selected && this.dispatch("nodeUnselected", !0)),
                                ...
                                this.node_selected != this.ele_selected && this.dispatch("nodeSelected", this.ele_selected.id.slice(5)),
                                (this.node_selected = this.ele_selected),
                                this.node_selected.classList.add("selected"),
                                this.draggable_inputs
                                    ? "SELECT" !== e.target.tagName && (this.drag = !0)
                                    : "INPUT" !== e.target.tagName && "TEXTAREA" !== e.target.tagName && "SELECT" !== e.target.tagName && !0 !== e.target.hasAttribute("contenteditable") && (this.drag = !0);
                            break;
                        case "output":
                            (this.connection = !0),
                        ...
                        case "main-path":
                            ...
                            this.dispatch("connectionSelected", { output_id: t[2].slice(14), input_id: t[1].slice(13), output_class: t[3], input_class: t[4] }),
                                this.reroute_fix_curvature &&
                                this.connection_selected.parentElement.querySelectorAll(".main-path").forEach((e, t) => {
                    ...
                    "touchstart" === e.type
                        ? ((this.pos_x = e.touches[0].clientX), (this.pos_x_start = e.touches[0].clientX), (this.pos_y = e.touches[0].clientY), (this.pos_y_start = e.touches[0].clientY))
                        : ((this.pos_x = e.clientX), (this.pos_x_start = e.clientX), (this.pos_y = e.clientY), (this.pos_y_start = e.clientY)),
                ...
                position(e) {
                    ...
                    if (
                        ...
                        (this.pos_x = t),
                            (this.pos_y = n),
                            (this.ele_selected.style.top = this.ele_selected.offsetTop - s + "px"),
                            (this.ele_selected.style.left = this.ele_selected.offsetLeft - i + "px"),
                            (this.drawflow.drawflow[this.module].data[this.ele_selected.id.slice(5)].pos_x = this.ele_selected.offsetLeft - i),
                            (this.drawflow.drawflow[this.module].data[this.ele_selected.id.slice(5)].pos_y = this.ele_selected.offsetTop - s),
                ...
                dragEnd(e) {
                    ...
                    if (
                        (this.drag && ((this.pos_x_start == t && this.pos_y_start == n) || this.dispatch("nodeMoved", this.ele_selected.id.slice(5))),
                            this.drag_point && (this.ele_selected.classList.remove("selected"), (this.pos_x_start == t && this.pos_y_start == n) || this.dispatch("rerouteMoved", this.ele_selected.parentElement.classList[2].slice(14))),
                            this.editor_selected && ((this.canvas_x = this.canvas_x + -(this.pos_x - t)), (this.canvas_y = this.canvas_y + -(this.pos_y - n)), (this.editor_selected = !1)),
                            !0 === this.connection)
                    )
                    ...
                    (this.drag = !1), (this.drag_point = !1), (this.connection = !1), (this.ele_selected = null), (this.editor_selected = !1);
                }
                contextmenu(e) {
                ...
                key(e) {
                    ...
                    ("Delete" === e.key || ("Backspace" === e.key && e.metaKey)) &&
                        (null != this.node_selected && "INPUT" !== this.first_click.tagName && "TEXTAREA" !== this.first_click.tagName && !0 !== this.first_click.hasAttribute("contenteditable") && this.removeNodeId(this.node_selected.id),
                ...
                updateConnectionNodes(e) {
                    ...
                    Object.keys(f).map(function (t, n) {
                        if (null === f[t].querySelector(".point")) {
                            var g = i.querySelector("#" + e),
                                m = f[t].classList[1].replace("node_in_", ""),
                                _ = i.querySelector("#" + m).querySelectorAll("." + f[t].classList[4])[0],
                                ...
                                y = g.querySelectorAll("." + f[t].classList[3])[0],
                            ...
                            n.forEach((t, a) => {
                                if (0 === a && n.length - 1 == 0) {
                                    var f = i.querySelector("#" + e),
                                        m = ((x = t).getBoundingClientRect().x - s.getBoundingClientRect().x) * u + r,
                                    ...
                                    (m = (R = E.querySelectorAll("." + t.parentElement.classList[4])[0]).offsetWidth / 2 + (R.getBoundingClientRect().x - s.getBoundingClientRect().x) * u),
                                        (_ = R.offsetHeight / 2 + (R.getBoundingClientRect().y - s.getBoundingClientRect().y) * p),
                                        (w = (f.getBoundingClientRect().x - s.getBoundingClientRect().x) * u + r),
                                        (v = (f.getBoundingClientRect().y - s.getBoundingClientRect().y) * p + r),
                                        (y = l(w, v, m, _, d, "close"));
                                    (o += y), g.push(y);
                                } else if (0 === a) {
                                    var L;
                                    ...
                                    (o += y), g.push(y);
                                    (f = t),
                                        (m = ((x = n[a + 1]).getBoundingClientRect().x - s.getBoundingClientRect().x) * u + r),
                                        (_ = (x.getBoundingClientRect().y - s.getBoundingClientRect().y) * p + r),
                                        (w = (f.getBoundingClientRect().x - s.getBoundingClientRect().x) * u + r),
                                        (v = (f.getBoundingClientRect().y - s.getBoundingClientRect().y) * p + r),
                                        (y = l(w, v, m, _, c, "other"));
                                    ...
                                    var E, R;
                                    (f = t),
                                        (C = t.parentElement.classList[1].replace("node_in_", "")),
                                        (x = (E = i.querySelector("#" + C)).querySelectorAll("." + t.parentElement.classList[4])[0]),
                                        (m = (R = E.querySelectorAll("." + t.parentElement.classList[4])[0]).offsetWidth / 2 + (R.getBoundingClientRect().x - s.getBoundingClientRect().x) * u),
                                        (_ = R.offsetHeight / 2 + (R.getBoundingClientRect().y - s.getBoundingClientRect().y) * p),
                                        (w = (f.getBoundingClientRect().x - s.getBoundingClientRect().x) * (s.clientWidth / (s.clientWidth * h)) + r),
                                        (v = (f.getBoundingClientRect().y - s.getBoundingClientRect().y) * (s.clientHeight / (s.clientHeight * h)) + r),
                                        (y = l(w, v, m, _, d, "close"));
                                    (o += y), g.push(y);
                                } else {
                                    (f = t),
                                        (m = ((x = n[a + 1]).getBoundingClientRect().x - s.getBoundingClientRect().x) * (s.clientWidth / (s.clientWidth * h)) + r),
                                        (_ = (x.getBoundingClientRect().y - s.getBoundingClientRect().y) * (s.clientHeight / (s.clientHeight * h)) + r),
                                        (w = (f.getBoundingClientRect().x - s.getBoundingClientRect().x) * (s.clientWidth / (s.clientWidth * h)) + r),
                                        (v = (f.getBoundingClientRect().y - s.getBoundingClientRect().y) * (s.clientHeight / (s.clientHeight * h)) + r),
                                        (y = l(w, v, m, _, c, "other"));
                                    (o += y), g.push(y);
                    ...
                    const g = i.querySelectorAll("." + t);
                    Object.keys(g).map(function (t, n) {
                        if (null === g[t].querySelector(".point")) {
                            var h = i.querySelector("#" + e),
                                f = g[t].classList[2].replace("node_out_", ""),
                                m = i.querySelector("#" + f).querySelectorAll("." + g[t].classList[3])[0],
                                _ = m.offsetWidth / 2 + (m.getBoundingClientRect().x - s.getBoundingClientRect().x) * u,
                                w = m.offsetHeight / 2 + (m.getBoundingClientRect().y - s.getBoundingClientRect().y) * p,
                                v = (h = h.querySelectorAll("." + g[t].classList[4])[0]).offsetWidth / 2 + (h.getBoundingClientRect().x - s.getBoundingClientRect().x) * u,
                                y = h.offsetHeight / 2 + (h.getBoundingClientRect().y - s.getBoundingClientRect().y) * p;
                            const n = l(_, w, v, y, o, "openclose");
                            g[t].children[0].setAttributeNS(null, "d", n);
                        } else {
                            const n = g[t].querySelectorAll(".point");
                            let o = "";
                            const h = [];
                            n.forEach((t, a) => {
                                if (0 === a && n.length - 1 == 0) {
                                    var f = i.querySelector("#" + e),
                                        g = ((C = t).getBoundingClientRect().x - s.getBoundingClientRect().x) * u + r,
                                        m = (C.getBoundingClientRect().y - s.getBoundingClientRect().y) * p + r,
                                    ...
                                    (g = (x = L.querySelectorAll("." + t.parentElement.classList[3])[0]).offsetWidth / 2 + (x.getBoundingClientRect().x - s.getBoundingClientRect().x) * u),
                                        (m = x.offsetHeight / 2 + (x.getBoundingClientRect().y - s.getBoundingClientRect().y) * p),
                                        (_ = (f.getBoundingClientRect().x - s.getBoundingClientRect().x) * u + r),
                                        (w = (f.getBoundingClientRect().y - s.getBoundingClientRect().y) * p + r),
                                        (v = l(g, m, _, w, d, "open"));
                                    (o += v), h.push(v);
                                } else if (0 === a) {
                                    var x;
                                    (f = t),
                                        (y = t.parentElement.classList[2].replace("node_out_", "")),
                                        (C = (L = i.querySelector("#" + y)).querySelectorAll("." + t.parentElement.classList[3])[0]),
                                        (g = (x = L.querySelectorAll("." + t.parentElement.classList[3])[0]).offsetWidth / 2 + (x.getBoundingClientRect().x - s.getBoundingClientRect().x) * u),
                                        (m = x.offsetHeight / 2 + (x.getBoundingClientRect().y - s.getBoundingClientRect().y) * p),
                                        (_ = (f.getBoundingClientRect().x - s.getBoundingClientRect().x) * u + r),
                                    ...
                                    (o += v), h.push(v);
                                    (f = t),
                                        (_ = ((C = n[a + 1]).getBoundingClientRect().x - s.getBoundingClientRect().x) * u + r),
                                        (w = (C.getBoundingClientRect().y - s.getBoundingClientRect().y) * p + r),
                                        (g = (f.getBoundingClientRect().x - s.getBoundingClientRect().x) * u + r),
                                        (m = (f.getBoundingClientRect().y - s.getBoundingClientRect().y) * p + r),
                                        (v = l(g, m, _, w, c, "other"));
                                    (o += v), h.push(v);
                                } else if (a === n.length - 1) {
                                    var L, E;
                                    (f = t),
                                        ...
                                        (C = (L = i.querySelector("#" + y)).querySelectorAll("." + t.parentElement.classList[4])[0]),
                                        (_ = (E = L.querySelectorAll("." + t.parentElement.classList[4])[0]).offsetWidth / 2 + (E.getBoundingClientRect().x - s.getBoundingClientRect().x) * u),
                                        (w = E.offsetHeight / 2 + (E.getBoundingClientRect().y - s.getBoundingClientRect().y) * p),
                                        (g = (f.getBoundingClientRect().x - s.getBoundingClientRect().x) * u + r),
                                        (m = (f.getBoundingClientRect().y - s.getBoundingClientRect().y) * p + r),
                                        (v = l(g, m, _, w, d, "close"));
                                ...
                                a
                                    ? h.forEach((e, n) => {
                                        g[t].children[n].setAttributeNS(null, "d", e);
                                    })
                                    : g[t].children[0].setAttributeNS(null, "d", o);
                        }
                    });

                    this.dispatch("connectionUpdated", { output_id: e, input_id: t, output_class: n, input_class: i });
                }
                dblclick(e) {
                ...
                createReroutePoint(e) {
                    ...
                    void 0 === this.drawflow.drawflow[this.module].data[r].outputs[i].connections[h].points && (this.drawflow.drawflow[this.module].data[r].outputs[i].connections[h].points = []),
                        this.reroute_fix_curvature
                            ? (d > 0
                ...
                addNode(e, t, n, i, s, o, l, c, d = !1, decisor = !1) {
                    if (this.useuuid) var a = this.getUuid();
                    else a = this.nodeId;
                    const r = document.createElement("div");
                    r.classList.add("parent-node");
                    const h = document.createElement("div");
                    (h.innerHTML = ""), h.setAttribute("id", "node-" + a), h.classList.add("drawflow-node"), "" != o && h.classList.add(o);
                    ...
                    for (var g = 0; g < t; g++) {
                        ...
                        e.classList.add("input"), e.classList.add("input_" + (g + 1)), (f["input_" + (g + 1)] = { connections: [] }), u.appendChild(e);
                    }
                    const m = {};
                    for (g = 0; g < n; g++) {
                        const e = document.createElement("div");
                        e.classList.add("output"), e.classList.add("output_" + (g + 1)), (m["output_" + (g + 1)] = { connections: [] });
                        if (decisor) {
                            if (g === 0)
                                e.classList.add("outputFalso")
                            else
                                e.classList.add("outputVerdadeiro")
                        }
                        p.appendChild(e);
                    }
                    ...
                    if ((_.classList.add("drawflow_content_node"), !1 === d)) _.innerHTML = c;
                        ...
                        let e = new this.render({ parent: this.parent, render: (e) => e(this.noderegister[c].html, { props: this.noderegister[c].props }), ...this.noderegister[c].options }).$mount();
                        _.appendChild(e.$el);
                    }
                    Object.entries(l).forEach(function (e, t) {
                        if ("object" == typeof e[1])
                            !(function e(t, n, i) {
                                ...
                                null !== t &&
                                    Object.entries(t).forEach(function (n, s) {
                                        if ("object" == typeof n[1]) e(t, n[0], i + "-" + n[0]);
                                        else for (var o = _.querySelectorAll("[df-" + i + "-" + n[0] + "]"), l = 0; l < o.length; l++) (o[l].value = n[1]), o[l].isContentEditable && (o[l].innerText = n[1]);
                                    });
                            })(null, e[0], e[0]);
                        else for (var n = _.querySelectorAll("[df-" + e[0] + "]"), i = 0; i < n.length; i++) (n[i].value = e[1]), n[i].isContentEditable && (n[i].innerText = e[1]);
                    }),
                        h.appendChild(u),
                        h.appendChild(_),
                        h.appendChild(p),
                    ...
                    var w = { id: a, name: e, data: l, class: o, html: c, typenode: d, inputs: f, outputs: m, pos_x: i, pos_y: s };
                ...
                addNodeImport(e, t) {
                    ...
                    (i.innerHTML = ""), i.setAttribute("id", "node-" + e.id), i.classList.add("drawflow-node"), "" != e.class && i.classList.add(e.class);
                    ...
                    if ((c.classList.add("drawflow_content_node"), !1 === e.typenode)) c.innerHTML = e.html;
                        ...
                        let t = new this.render({ parent: this.parent, render: (t) => t(this.noderegister[e.html].html, { props: this.noderegister[e.html].props }), ...this.noderegister[e.html].options }).$mount();
                        c.appendChild(t.$el);
                    }
                    Object.entries(e.data).forEach(function (t, n) {
                        if ("object" == typeof t[1])
                            !(function t(n, i, s) {
                                ...
                                null !== n &&
                                    Object.entries(n).forEach(function (e, i) {
                                        if ("object" == typeof e[1]) t(n, e[0], s + "-" + e[0]);
                                        else for (var o = c.querySelectorAll("[df-" + s + "-" + e[0] + "]"), l = 0; l < o.length; l++) (o[l].value = e[1]), o[l].isContentEditable && (o[l].innerText = e[1]);
                                    });
                            })(null, t[0], t[0]);
                        else for (var i = c.querySelectorAll("[df-" + t[0] + "]"), s = 0; s < i.length; s++) (i[s].value = t[1]), i[s].isContentEditable && (i[s].innerText = t[1]);
                    }),
                        i.appendChild(s),
                        i.appendChild(c),
                        i.appendChild(o),
                    ...
                    this.dispatch("nodeCreated", e.id);
                }
                addRerouteImport(e) {
                        ...
                        Object.keys(e.outputs[s].connections).map(function (o, l) {
                            ...
                            void 0 !== c &&
                                c.forEach((l, d) => {
                                    ...
                                    var g = l.pos_x,
                                        m = l.pos_y;
                                    f.setAttributeNS(null, "cx", g), f.setAttributeNS(null, "cy", m), f.setAttributeNS(null, "r", t), h.appendChild(f);
                                });
                        });
                    });
                }
                    ...
                    for (var t = e.target.attributes, n = 0; n < t.length; n++)
                        if (t[n].nodeName.startsWith("df-")) {
                            ...
                            (s[i[i.length - 1]] = e.target.value),
                                e.target.isContentEditable && (s[i[i.length - 1]] = e.target.innerText),
                                ...
                                !(function e(i, s, o) {
                                    ...
                                    null !== i &&
                                        Object.entries(i).forEach(function (t, s) {
                                            ...
                                            else for (var l = n.querySelectorAll("[df-" + o + "-" + t[0] + "]"), c = 0; c < l.length; c++) (l[c].value = t[1]), l[c].isContentEditable && (l[c].innerText = t[1]);
                                        });
                                })(null, e[0], e[0]);
                            else for (var s = n.querySelectorAll("[df-" + e[0] + "]"), o = 0; o < s.length; o++) (s[o].value = e[1]), s[o].isContentEditable && (s[o].innerText = e[1]);
                        });
                    }
                }
                addNodeInput(e) {
                ...
                removeNodeInput(e, t) {
                    ...
                    if (
                        (o.forEach((t, i) => {
                            ...
                            (d = new Set(d.map((e) => JSON.stringify(e)))),
                            (d = Array.from(d).map((e) => JSON.parse(e))),
                            this.module === n)
                    ) {
                        ...
                        this.drawflow.drawflow[n].data[t.node].outputs[t.input].connections.forEach((i, s) => {
                            if (i.node == e) {
                                ...
                                if (parseInt(c) < parseInt(o)) {
                                    ...
                                    i.points
                                        ? (this.drawflow.drawflow[n].data[t.node].outputs[t.input].connections[s] = { node: i.node, output: "input_" + (o - 1), points: i.points })
                                        : (this.drawflow.drawflow[n].data[t.node].outputs[t.input].connections[s] = { node: i.node, output: "input_" + (o - 1) });
                                }
                            }
                        });
                    }),
                ...
                removeConnection() {
                    if (null != this.connection_selected) {
                        ...
                        this.drawflow.drawflow[this.module].data[e[1].slice(13)].inputs[e[4]].connections.splice(n, 1),
                ...
                removeConnectionNodeId(e) {
                    ...
                    for (s = d.length - 1; s >= 0; s--) {
                        (o = d[s].classList),
                            (c = this.drawflow.drawflow[this.module].data[o[2].slice(14)].outputs[o[3]].connections.findIndex(function (e, t) {
                                return e.node === o[1].slice(13) && e.output === o[4];
                            }));
                        this.drawflow.drawflow[this.module].data[o[2].slice(14)].outputs[o[3]].connections.splice(c, 1);
                        l = this.drawflow.drawflow[this.module].data[o[1].slice(13)].inputs[o[4]].connections.findIndex(function (e, t) {
